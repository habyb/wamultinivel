...
class FixCityUsers extends Command
{
    ...
    public function handle()
    {
        $fixedCities = [
            ...
            'Barra do Piraí' => ['barra do piraí', 'barra do pirai', 'BARRA DO PIRAÍ', 'Barra do pirai', 'BARRA DO PIRAI', 'Barra do Pirai !', 'Barra do Piraí e Rio das flores', 'Barra do Piraí - RJ', 'Barra do Piraí -RJ', 'Barra do Piraí RJ', 'Barra do Piraí r.j', 'Barra do Piraí-RJ', 'Barra do Piraí.', 'Barrra do Piraí', 'Piraí', 'Barra do pirai R.J', 'Barra fo pirai', 'Barão do Piraí'],
            'Barra Mansa' => ['barra mansa', 'BARRA MANSA', 'Barra Mansa, Siderlandia', 'Barra Mansa.', 'BarraMansa'],
            'Belford Roxo' => ['belford roxo', 'BELFORD ROXO', 'belford roxo RJ centro', 'Belford'],
            ...
            'Rio de Janeiro' => ['Rio de janeiro', 'rio de janeiro', 'RIO DE JANEIRO', 'Río de Janeiro', 'Río de janeiro', 'Rio dd janeiro', 'Rio de Jnairo', 'Ri de Janeiro', 'Rio de janeiro - rio de janeiro', 'RJ', 'rj', 'Rj', 'Irajá - RJ', 'Lagoa Santa', 'Rio das Flores', 'Cavalcante', 'Campo Grande. RJ', 'rio de janeiro, campo grande', 'Campo Grande RJ', 'Campo Grande Rio de Janeiro', 'Campo grande', 'Rio  de  Janeiro', 'Rio  de Janeiro', 'Rio Janeiro', 'Rio de Janeio', 'Rio de Janeiro.', 'Rio de janeiro.', 'Rio de janeiro....', 'Rio de Jan', 'rio', 'Vila da penha', 'Vila da Penha', 'Rio e teresopolis', 'Rio de Janeiro/Bairro C.Grande', 'Rio de janeiro, RJ', 'Pavuna', 'Rio de Janeiro urucania.', 'Rj, santa cruz', 'Rio de Janeiro Santa Cruz', 'Rio de.janeiro', 'Moro em Bangu vila kennedy', 'Realengo', 'Ria de janeiro', 'Rio de janeiro/RJ', 'Rio de jeneiro', 'Rio de Janeiro/ campo grande', 'Rio d3 janeiro', 'Rio. De janeiro', 'Rio de janeiro Bangu', 'Realengo Rj', 'Vargem Grande, RJ', 'Inhoaiba', 'Rio de Janeiro Capital', 'Rio de Janeiri', 'Rio de Janeiro Penha', 'Penha', 'Vargem Grande,  RJ', 'Rio de Janeiro cordovil'],
            ...
            'São José do Vale do Rio Preto' => ['são josé do vale do rio preto', 'sao jose do vale do rio preto', 'São Jose do Vale do Rio Preto', 'Sjvrp'],
            ...
            'Valença' => ['Valença.', 'Valença RJ', 'Valença Rj', 'Valença. RJ', 'Valença rj', 'Valença/ RJ', 'valença', 'valenca', 'Valença, RJ', 'Valença-RJ', 'Valença-Rj', 'Valença - RJ', 'Valenca Rj', 'Valenca rj', 'VALENÇA', 'Valença/RJ.', 'Santa Isabel do Rio Preto - Valença', 'Valença E d R', 'Valença Estado do Rio .', 'Valença estado do Rio', 'Valençarj', 'Valença/RJ', 'Valença/Rj', 'Valença/rj', 'Santa Isabel do rio preto', 'Valença -rj', 'Valença estado rj', 'Valença ,interior do Rio de janeiro.', 'Est Do Rio De Janeiro Valença', 'Valença/ Santa Isabel do Rio preto!', 'Valença ..', 'Valença  RJ', 'Barão de Juparanã', 'Barão de juparanã', 'Barão de juparana', 'barão de juparana', 'Barao de Juparanã', 'Barao de juparanã', 'BARÃO DE JUPARANA.', 'Parapeúna', 'Parapeuna', 'parapeuna', 'Conservatória', 'Conservatoria', 'conservatoria', 'Valença  Estado do Rio', 'Parapeúna Valença', 'Santa Isabel', 'Santa Isabel do Rio Preto Distrito de Valença', 'Santa Isabel do Rio Preto Município de Valença', 'Barão de Juparanã - Valença', 'Barão de Juparanã Valença', 'Conservatória - Valença', 'Juoara', 'Juparana', 'Valença Estado do Rio de Janeiro', 'Valença Mais Tenho Casa Também No Rio', 'Elaine da Costa Eduardo Ramos Conservatória', 'Valença Distrito Barão de Juparana', 'Valença Rio de Janeiro', 'Valença Bairro São Francisco', 'Santa Isabel - Valença', 'Valnça', 'Parapeuna Valença', 'Valença R-J'],
