...
class FixCityUsers extends Command
{
    ...
    public function handle()
    {
        $fixedCities = [
            ...
            'Rio de Janeiro' => ['Rio de janeiro', 'rio de janeiro', 'RIO DE JANEIRO', 'Río de Janeiro', 'Río de janeiro', 'RJ', 'rj', 'Rj', 'Campo Grande. RJ', 'rio de janeiro, campo grande', 'Campo Grande RJ', 'Campo Grande Rio de Janeiro', 'Campo grande', 'Rio  de  Janeiro', 'Rio  de Janeiro', 'Rio Janeiro', 'Rio de Janeio', 'Rio de Janeiro.', 'Rio de janeiro.', 'Rio de janeiro....', 'rio', 'Vila da penha', 'Vila da Penha'],
