...
class FixCityUsers extends Command
{
    ...
    public function handle()
    {
        $fixedCities = [
            ...
            'Teresópolis' => ['Teresópolis rj', 'Teresópolis RJ', 'teresópolis', 'teresopolis', 'Taresopolis', 'Teresópolis, Rj', 'Teresópolis Estado do Rio', 'Rafael Teresópolis', 'Teresópolis Rio de Janeiro'],
