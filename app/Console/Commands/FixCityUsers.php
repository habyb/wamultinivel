...
class FixCityUsers extends Command
{
    ...
    public function handle()
    {
        $fixedCities = [
            ...
            'Valença' => ['Valença.', 'Valença RJ', 'Valença Rj', 'Valença rj', 'valença', 'valenca', 'Valença-RJ', 'Valença-Rj', 'Valença - RJ', 'Valenca Rj', 'Valenca rj', 'Santa Isabel do Rio Preto - Valença', 'Valença E d R', 'Valença Estado do Rio .', 'Valença estado do Rio', 'Valençarj', 'Valença/RJ', 'Valença/Rj', 'Valença/rj', 'Santa Isabel do rio preto', 'Valença -rj', 'Valença estado rj', 'Valença ,interior do Rio de janeiro.', 'Est Do Rio De Janeiro Valença', 'Valença/ Santa Isabel do Rio preto!', 'Valença ..', 'Valença  RJ', 'Barão de Juparanã', 'Barão de juparanã', 'Barão de juparana', 'barão de juparana', 'Barao de Juparanã', 'Barao de juparanã', 'Parapeúna', 'Parapeuna', 'parapeuna', 'Conservatória', 'Conservatoria', 'conservatoria'],
