...
class FixCityUsers extends Command
{
    ...
    public function handle()
    {
        $fixedCities = [
            ...
            'Rio de Janeiro' => ['Rio de janeiro', 'rio de janeiro', 'RIO DE JANEIRO', 'Río de Janeiro', 'Río de janeiro', 'RJ', 'rj', 'Rj'],
            ...
            'Valença' => ['Valença RJ', 'Valença Rj', 'Valença rj', 'valença', 'valenca', 'Valença-RJ', 'Valença-Rj'],
