...
class FixCityUsers extends Command
{
    ...
    public function handle()
    {
        $fixedCities = [
            ...
            'São Gonçalo' => ['São gonçalo', 'São goncalo', 'São Goncalo', 'são gonçalo', 'sao goncalo', 'São Gonçalo RJ', 'São Gonçalo/RJ'],
