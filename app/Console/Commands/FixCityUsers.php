...
class FixCityUsers extends Command
{
    ...
    public function handle()
    {
        $fixedCities = [
            ...
            'Barra do Piraí' => ['barra do piraí', 'barra do pirai', 'BARRA DO PIRAÍ', 'Barra do pirai', 'BARRA DO PIRAI', 'Barra do Pirai !', 'Barra do Piraí e Rio das flores', 'Barra do Piraí - RJ', 'Barra do Piraí -RJ', 'Barra do Piraí RJ', 'Barra do Piraí r.j', 'Barra do Piraí-RJ', 'Barra do Piraí.', 'Barrra do Piraí'],
