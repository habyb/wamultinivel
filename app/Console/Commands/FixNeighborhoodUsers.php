...
class FixNeighborhoodUsers extends Command
{
    ...
    public function handle()
    {
        $fixNeighborhoods = [
            ...
            'Agriões' => ['Agrioes', 'agrioes'],
            'Alto da Boa Vista' => ['alto da boa vista', 'ALTO DA BOA VISTA'],
            'Anchieta' => ['anchieta', 'ANCHIETA', 'Anchieta Rio de Janeiro'],
            'Andaraí' => ['andarai', 'ANDARAÍ'],
            'Anil' => ['anil', 'ANIL'],
            'Bancários' => ['bancarios', 'BANCÁRIOS'],
            'Bangu' => ['bangu', 'BANGU'],
            'Barra da Tijuca' => ['barra da tijuca', 'barra tijuca', 'BARRA DA TIJUCA', 'Barra Olimpica.', 'Barra Olímpica'],
            ...
            'Bonsucesso' => ['bonsucesso', 'BONSUCCESSO', 'Bonssucesso'],
            ...
            'Campo Grande' => ['Campo grande', 'campo grande', 'CAMPO GRANDE', 'Campo Grande carobinha', 'Campo Grande mendanha', 'Campo grande Rio de janeiro'],
            'Cascadura' => ['cascadura', 'CASCADURA'],
            'Catete' => ['catete', 'CATETE'],
            'Catumbi' => ['catumbi', 'CATUMBI'],
            'Cavalcanti' => ['cavalcanti', 'CAVALCANTI'],
            'Centro' => ['Avenida General de Lima Bastos , número 119 centro.'],
            ...
            'Curicica' => ['curicica', 'CURICICA', 'Curicica - JPA'],
            ...
            'Maracanã' => ['maracana', 'MARACANÃ', 'Bairro do Maracanã'],
            'Maré' => ['mare', 'MARÉ'],
            ...
            'Penha' => ['penha', 'PENHA', 'Penha', 'Bairro da penha'],
